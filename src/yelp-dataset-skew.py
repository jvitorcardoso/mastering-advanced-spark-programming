"""
Use of Repartition or Coalesce to avoid data skew in Spark
...
# TODO date of 2024-07-02 = 122.466.330 {skewed}
spark.sql("""
    SELECT r.date,
        COUNT(*) AS qtd
    FROM reviews r
...
# TODO query using skewed date [2024-02-07] =
spark.sql("""
